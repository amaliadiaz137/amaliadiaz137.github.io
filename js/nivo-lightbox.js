...
(function ($, window, document, undefined) {
  ...
  NivoLightbox.prototype = {
    ...
    processContent: function (content, link) {
      ...
      // Set the description
      if (link.attr("description")) {
        var descWrap = $("<span>", { class: "nivo-lightbox-desc" });
        descWrap.text(link.attr("description"));
        $(".nivo-lightbox-desc-wrap").html(descWrap);
      } else {
        $(".nivo-lightbox-desc-wrap").html("");
      }
    },
    ...
    constructLightbox: function () {
      ...
      var description = $("<div>", { class: "nivo-lightbox-desc-wrap" });
